...
M-05 | design-ambiguity | situation | must | what the feature is stays open: content, direction, realisations, tunable numbers | mechanical work; a spec locked earlier | meta-contract-before-execution → Spec Lock; CASEBOOK.yaml → M-05 precedents | ratified
...
M-19 | drift-analysis | situation | ambient | the pioneer asks what happened, or an audit shows an aspect ABSENT twice | a single ABSENT (M-18) | meta-antidrift-expand | ratified
